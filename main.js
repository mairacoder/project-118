...
draw_iamge= quick_draw_data_set[random_number];
...
function update_canvas() {
    background("white");
    random_number = Math.floor((Math.random()*quick_draw_data_set.lenghth )-1);
...
function gotResult(error, results){
    ...
    document.getElementById('confi_dence').innerHTML = 'Confidence: ' + Math.round(results[0].confidence * 100) + '%'
